...
CARS_URL = urljoin(
    BASE_URl,
    "search/?categories.main.id=1&brand.id[0]=79&model.id[0]=2104&indexName=auto,order_auto,newauto_search&damage.not=0&country.import.usa.not=0&size=100",
)
...
def insert_car_data(
    model, price, mileage, ria_url, page_id, photo_ria, auction_url, is_sold
):
    insert_query = """
